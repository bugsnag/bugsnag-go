...
Background:
  Given I set environment variable "BUGSNAG_SOURCE_ROOT" to "app/src/test/"
...
Scenario: Sending an event using a callback to modify report contents
  ...
  And the "file" of stack frame 0 equals "main.go"
  And the "lineNumber" of stack frame 0 equals 242
...
Scenario: Marking an error as unhandled in a callback
  ...
  And the "file" of stack frame 0 equals "main.go"
  And the "lineNumber" of stack frame 0 equals 254
